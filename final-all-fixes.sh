#!/bin/bash
# 完整版MCP服务Docker修复脚本 - 最终版

# 设置错误处理
set -e
echo "开始执行完整版修复脚本 - 最终版..."

# 为所有修复脚本添加执行权限
chmod +x fix-function-return-types.cjs fix-quotes-errors.cjs fix-object-properties.cjs fix-route-handlers.cjs fix-route-quotes.cjs fix-parameter-syntax.cjs

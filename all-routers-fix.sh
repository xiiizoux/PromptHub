...
sudo docker cp all-api-fix.cjs prompthub:/app/all-api-fix.cjs
...
# 在容器内执行修复脚本
echo "在Docker容器中执行全面修复脚本..."
sudo docker exec prompthub node /app/all-api-fix.cjs

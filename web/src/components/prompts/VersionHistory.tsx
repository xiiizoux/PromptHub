      ...
      <Dialog as="div" className="relative z-50" onClose={onClose || (() => {})}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl glass border border-neon-cyan/20 p-6 text-left align-middle shadow-xl transition-all">
                {renderVersionHistoryContent()}
        ...
        {/* 内容查看模态框 */}
        <Transition appear show={showContent} as={Fragment}>
            ...
            <div className="fixed inset-0 overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-4 text-center">
                <Transition.Child
                  ...
                  leaveTo="opacity-0 scale-95"
                >
                  <Dialog.Panel className="w-full max-w-3xl transform overflow-hidden rounded-2xl glass border border-neon-cyan/20 p-6 text-left align-middle shadow-xl transition-all">

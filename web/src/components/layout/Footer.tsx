      ...
      <div className="container-tight mx-auto py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <Link href="/" className="flex items-center">
              <div className="rounded-full overflow-hidden h-8 w-8 shadow-sm">
                <img 
                  src="/images/logo.png" 
                  alt="PromptHub Logo" 
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <div className="flex flex-col sm:flex-row sm:items-center">
            ...
            <div className="flex mt-2 sm:mt-0 sm:ml-6 space-x-4">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            <a href="https://github.com/xiiizoux/PromptHub" className="text-gray-500 hover:text-primary-600" target="_blank" rel="noopener noreferrer">

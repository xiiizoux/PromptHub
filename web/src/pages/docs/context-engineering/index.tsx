/**
 * Context Engineering 文档主页
 * 
 * 全面介绍Context Engineering的概念、价值和在PromptHub中的实现
 */
...
export default function ContextEngineeringIndex() {
  return (
    ...
    >
          ...
          <div className="glass rounded-2xl p-8 border border-neon-purple/30">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div>
                ...
                <p className="text-gray-300 leading-relaxed mb-4">
                  Context Engineering（上下文工程）是一种革命性的AI交互方法论，它通过构建智能化的上下文适应系统，
                  让AI能够根据用户的个人偏好、使用习惯、历史交互和当前情境，动态调整其回应方式和内容。
                </p>
                <p className="text-gray-300 leading-relaxed">
                  与传统的静态提示词不同，Context Engineering创建了一个<strong className="text-neon-purple">学习型、适应型</strong>的AI交互环境，
                  使每次对话都更加精准、个性化和高效。
                </p>
              </div>
            ...
            <div className="p-6 bg-neon-purple/10 border border-neon-purple/30 rounded-xl">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                而通过Context Engineering，它会记住您是Python开发者、偏好简洁注释、关注性能优化，
        ...
        {/* Context Engineering vs 传统Prompt */}
        <motion.section
          className="mb-16"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-600">
                    ...
                    <th className="text-left py-4 px-6 text-gray-300 font-medium">Context Engineering</th>
                  </tr>
                </thead>
        ...
        {/* PromptHub中的Context Engineering */}
        <motion.section
          className="mb-16"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="glass rounded-2xl p-8 border border-neon-green/30">
            <h2 className="text-3xl font-bold text-white mb-8 flex items-center">
              ...
              PromptHub中的Context Engineering实现
            </h2>
